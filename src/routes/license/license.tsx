...
export default function Home() {
  return (
    <Container sx={{ mt: 2 }}>
      ...
      <Typography>
        The full-text Open Legend Community License can be found at <Link href="https://openlegendrpg.com/community-license">https://openlegendrpg.com/community-license</Link>.
      </Typography>
    </Container>
  );
};